...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 gap-4 bg-[var(--bg-secondary)] border-l border-[var(--border)] p-6 shadow-xl transition-transform duration-300 ease-in-out",
    ...
    >
      ...
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none">
        <X className="h-5 w-5" color="var(--text-secondary)" />
